...
export default {
      ...
      return (
        <div>
          ...
          <Popup position="bottom" v-model:show={showPicker.value}>
            <Picker
              columns={new Function(`${props.columns}; return columns;`)()}
              onConfirm={(data: any) => {
                actions.confirm &&
  ...
  icon: IconHelper("mdi:chart-donut"),
  draggable: true,
  events: [{ label: "选择完成时", value: "confirm", code: confirmCode }],
  order: 14,
} as EditorComponent;
